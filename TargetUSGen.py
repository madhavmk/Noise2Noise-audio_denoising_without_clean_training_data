...
# target_folder = input("Enter target directory to generate noisy samples: ")
target_folder = "../Datasets/clean_trainset_28spk_wav"
noise_type = int(input("Enter noise type (0 to 9) :"))

#num_per_fold = int(input("Enter no. of new samples per fold: "))
...
#op_folder = "../Datasets/US_Mixed_Train_Output"
